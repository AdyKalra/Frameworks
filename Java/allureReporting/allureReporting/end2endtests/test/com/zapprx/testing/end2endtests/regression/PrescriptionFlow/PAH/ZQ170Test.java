 ...
 * prescribe medication to newly registered patient Step 3: User clicks on Mark
 * As Sent and validate unable to submit Rx without entering date
 **/
public class ZQ170Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQ170Test(String baseUrl) {
	...
	@Test
	public void Step03_verifyRxIsNotSubWithoutDateForMAS() {
		...
		test.presDetailsPage.verifyRxNotSubWithoutDate();
	}
