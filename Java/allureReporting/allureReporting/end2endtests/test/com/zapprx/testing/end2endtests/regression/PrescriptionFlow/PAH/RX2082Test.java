 ...
 * complete profile. Step 2: Complete Rx and verify that on prescription details
 * page Date of Birth field is correctly displayed.
 * 
 * @author vivekdua
 */
public class RX2082Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private RX2082Test(String baseUrl) {
	...
	@Test
	public void Step02_completeRxAndVerifyDateOfBirth() {
		...
		test.presDetailsPage.verifyDateOfBirth(patientLastNameDOBAndGender[1]);
	}
