 ...
 * validate newly created patient is displayed in Patient's list. Step 2: Create
 * Rx for any medication and continue to authorize. Validate the error message
 * if user type the signature and click on draw signature, then authorize .
 * 
 * @author vivekdua
 *
 */
public class ZQU82Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQU82Test(String baseUrl) {
	...
	@Test
	public void Step02_prescribePatientAndVerifySignErrorMsg() {
		...
		test.authorizationPage.enterPrescriberAuth(patientLastNameDOBAndGender[2], remsValue,
				getYamlValue("physician.indication1.medicines.medicine5.name"));
		test.authorizationPage.clickOnDrawSig();
		test.authorizationPage.clickOnSubmitButton();
		test.authorizationPage.verifyErrorMsgForSign(getYamlValue("physician.signErrorMsg"));
	}
