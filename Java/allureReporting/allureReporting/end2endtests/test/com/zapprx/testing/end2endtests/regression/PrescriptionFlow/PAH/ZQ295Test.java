 ...
 * the newly created patient Step 2: Physician select indication and validates
 * order of drug
 */
public class ZQ295Test extends BaseTest {
	String[] loginEmailAndMRN;
	String[] patientLastNameDOBAndGender = null;

	private ZQ295Test(String baseUrl) {
	...
	@Test
	public void Step02_verifyOrderOfDrugs() {
		test.patientCommonWorkflow.clickPresAndSelectIndication(getYamlValue("physician.indication1.name"));
		test.headerPage.verifyHeaderText("Choose a medication");
		test.chooseMedicationPage.verifyOrderOfDrugs("Oral", "Inhaled", "Infused");
	}
