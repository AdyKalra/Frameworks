 ...
 * Univera as Primary insurance Step 2: Physician prescribe under PAH indication
 * Step 3: Patient clicks on Print button Step 4: Fetch ids from HTML Form and
 * Prior Authorization Request Form to check common values in both the forms
 */

@Test(groups = "TestExclude")
public class UniveraPATest extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private UniveraPATest(String baseUrl) {
	...
	public void Step01_registerPatientAndCompleteProfile() {
		...
		test.patientCommonWorkflow.completeProfile(getYamlValue("physician.insuranceInfo.insuranceName10"),
	...
	public void Step02_prescribePatientAndPriorAuthForDiffMedication_Univera_Insurance(String medicineName) {
		...
		test.patientCommonWorkflow.fetchListAndCompare(medicineName, getYamlValue("physician.formTitle.title6"));
	...
	public Object[][] getMedications() {
		return test.chooseMedicationPage.getMedicinesForUnivera();
	}
