 ...
 * Now prescribe 'Adcirca' medication to newly registered patient, authorize the
 * prescription and verify authorization success message.
 * 
 * @author vivekdua
 *
 */
public class ZQ257Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQ257Test(String baseUrl) {
	...
	@Test
	public void Step02_presPatAndVerifyAuthSuccessMsg() {
