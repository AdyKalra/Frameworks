 ...
 * complete profile using 'Aetna' Primary Insurance. Step 2: Prescribe patient
 * 'Adcirca' medication and authorize prescription. Step 3: Click on 'Prior
 * authorization' from prescription details page and verify PA form title
 * 
 * @author QAIT\priyankasingh
 */
public class ZQ277Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQ277Test(String baseUrl) {
	...
	@Test
	public void Step02_prescribePatientAndAuthorize() {
	...
	@Test
	public void Step03_verifyPAFormTitle() {
		test.presDetailsPage.clickOnPriorAuthorization();
		test.priorAuthorizationPage.verifyPAFormIsDisplayed(getYamlValue("physician.formTitle.title2"));
	}
