 ...
 * the newly created patient Step 2: Physician prescribe and verify the rx
 * status under Quick Info Step 3: Physician now request prior authorization and
 * verify the rx status under Quick Info Step 4: Patient login and sign the
 * health share Step 5: Physician login to verify the rx status under Quick Info
 * and complete the process
 * 
 * @author vivekdua
 *
 */
public class ZQ2Test extends BaseTest {
	String[] loginEmailAndMRN;
	String[] patientLastNameDOBAndGender = null;

	private ZQ2Test(String baseUrl) {
	...
	@Test
	public void Step02_prescribePatientAndVerifyRxStatus() {
	...
	@Test
	public void Step03_requestPriorAuthAndVerifyRxStatus() {
	...
	@Test
	public void Step04_patientVerifyAndSignHealthShare() {
	...
	@Test
	public void Step05_physicianVerifyRxStatusAndComplete() {
