 ...
 * prescribe medication to newly registered patient and enter special
 * instruction on dosage page. Step 3:On prescription details page validate
 * value for special instruction is displayed, entered on dosage page
 * 
 * @author vivekdua
 *
 */
public class ZQ172Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQ172Test(String baseUrl) {
	...
	@Test
	public void Step02_prescribePatientAndEnterSpclInst() {
		...
		test.commonDosagePage.enterSpecialInstOrPresSpecfyAlt(getYamlValue("physician.specialInst"));
	...
	@Test
	public void Step03_verifySpecialInstructionValue() {
		test.headerPage.verifyUserIsOnCorrectPage("Prescription Details");
		test.presDetailsPage.expandPresDetails();
		test.presDetailsPage.verifySpecialInstOrPresSpecfyAlt(getYamlValue("physician.specialInst"));
	}
