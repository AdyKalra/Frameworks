...
public class ZQ70Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQ70Test(String baseUrl) {
	...
	@Test
	public void Step02_prescribePatientAndUploadFile() {
		...
		boolean remsValue = test.patientCommonWorkflow.prescribePatient(
				...
				getYamlValue("physician.indication1.medicines.medicine7.pharmacy.pharmacy1"),
				patientLastNameDOBAndGender[2], patientLastNameDOBAndGender[0], getYamlValue("physician.otherDetails"));
		test.commonDosagePage.selectMedicalRecord(getYamlValue("physician.medicalType"));
		test.commonDosagePage.uploadFileAndVerify(getYamlValue("physician.pdfFile"));
	...
	@Test
	public void Step03_requestPriorAuth() {
