 ...
 * Aetna as Primary insurance Step 2: Physician prescribe under PAH indication
...
public class AetnaPATest extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private AetnaPATest(String baseUrl) {
	...
	public void Step01_registerPatientAndCompleteProfile() {
		...
		test.patientCommonWorkflow.completeProfile(getYamlValue("physician.insuranceInfo.insuranceName6"),
	...
	public void Step02_prescribePatientAndPriorAuthForDiffMedication_Aetna_Insurance(String medicineName) {
		...
		test.patientCommonWorkflow.fetchListAndCompare(medicineName, getYamlValue("physician.formTitle.title2"));
	...
	public Object[][] getMedications() {
		return test.chooseMedicationPage.getAllMedicines();
	}
