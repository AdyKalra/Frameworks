 ...
 * Authorization and verify PA Status. Step 4: Now switch to pharmacy portal
 * access the PA form and verify Addtional Instruction is displayed on PA review
 * form
 * 
 * @author vivekdua
 */

public class ZQ246Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQ246Test(String baseUrl) {
		super("admin.baseUrl");
	}
	...
	public void Step03_completeRxAndSubmitPriorAuthorization() {
		...
		test.commonDosagePage.enterSpecialInstOrPresSpecfyAlt(getYamlValue("physician.additionalInst"));
	...
	@Test
	public void Step04_onPharmacyPortalVerifyAdditionalInst() {
		...
		test.priorAuthPage.verifyAdditionalInstOnPAFormReview(getYamlValue("physician.additionalInst"));
	}
