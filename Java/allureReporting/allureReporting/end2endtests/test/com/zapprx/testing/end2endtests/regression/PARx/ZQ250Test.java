 ...
 * physician and register new patient. Step 3: Prescribe patient 'Ampyra'
 * medication and authorize it. Step 4: Now again prescribe the patient with
 * some other medication say 'Aubagio'. Step 5: Access 'Prior authorization' and
 * verify 'Ampyra' medication is displayed under 'Prior Medications' section of
 * PA form and now click on patient name from header link to view patient
 * profile and verify both the medications were present in 'Prior and Current
 * Medications' under Clinical Tab.
 * 
 * @author vivekdua
 */

public class ZQ250Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ZQ250Test(String baseUrl) {
		super("admin.baseUrl");
	}
	...
	@Test
	public void Step04_againPrescribePatAndAuthorize() {
	...
	@Test
	public void Step05_verifyPriorMedicationOnPAFormAndOnPatProfile() {
		...
		test.patientProfilePage.verifyPriorAndCurrentMedications(
				getYamlValue("physician.indication3.medicines.medicine3.name"),
				getYamlValue("physician.indication3.medicines.medicine4.name"));
	}
