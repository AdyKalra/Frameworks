 ...
 * Excellus as Primary insurance Step 2: Physician prescribe under PAH
...
public class ExcellusPATest extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private ExcellusPATest(String baseUrl) {
	...
	public void Step01_registerPatientAndCompleteProfile() {
		...
		test.patientCommonWorkflow.completeProfile(getYamlValue("physician.insuranceInfo.insuranceName7"),
	...
	public void Step02_prescribePatientAndPriorAuthForDiffMedication_Excellus_Insurance(String medicineName) {
		...
		test.patientCommonWorkflow.fetchListAndCompare(medicineName, getYamlValue("physician.formTitle.title4"));
	...
	public Object[][] getMedications() {
		return test.chooseMedicationPage.getMedicinesForExcellus();
	}
