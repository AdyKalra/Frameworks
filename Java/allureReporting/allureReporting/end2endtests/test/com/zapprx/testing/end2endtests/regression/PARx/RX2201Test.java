 ...
 * Request More Info and verify that PA Status is updated
 * 
 * @author vivekdua
 */

public class RX2201Test extends BaseTest {
	String[] patientLastNameDOBAndGender = null;

	private RX2201Test(String baseUrl) {
		super("admin.baseUrl");
	}
	...
	@Test
	public void Step04_onPharmacyPortalVerifyPAStatusIsUpdated() {
